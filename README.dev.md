...
This guide is for developers working on Open i_Notes. For end-user documentation, see [README.md](README.md) and [docs/](docs/).

## Quick Start for Development

```bash
# 1. Clone and setup
git clone https://github.com/lfnovo/open-i_Notes.git
cd open-i_Notes
...
- `lfnovo/open_i_Notes:<version>` (from pyproject.toml)
- `lfnovo/open_i_Notes:local`

### Run Locally

```bash
docker run -p 5055:5055 -p 3000:3000 lfnovo/open_i_Notes:local
```
...
Open i_Notes supports internationalization. To add a new language:
...
├── open_i_Notes/          # Python core library
...
- [open_i_Notes/CLAUDE.md](open_i_Notes/CLAUDE.md)
