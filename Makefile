...
DOCKERHUB_IMAGE := lfnovo/open_i_Notes
GHCR_IMAGE := ghcr.io/lfnovo/open-i_Notes
...
# === Service Management ===
start-all:
	@echo "🚀 Starting Open i_Notes (Database + API + Worker + Frontend)..."
...
stop-all:
	@echo "🛑 Stopping all Open i_Notes services..."
...
status:
	@echo "📊 Open i_Notes Service Status:"
