...
Open i_Notes uses SurrealDB for its database needs. 

---

## Default Configuration

Open i_Notes should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Open i_Notes (recommended)
...
### DB running in the host machine and Open i_Notes running in Docker
...
### Open i_Notes and Surreal are running on the same machine
