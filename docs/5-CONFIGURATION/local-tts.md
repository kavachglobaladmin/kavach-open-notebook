...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Open i_Notes
...
```yaml
# In your Open i_Notes docker-compose.yml
environment:
...
### Step 5: Add Model in Open i_Notes
...
### Open i_Notes in Docker (macOS/Windows)

**TTS Base URL:** `http://host.docker.internal:8969/v1`

### Open i_Notes in Docker (Linux)
...
# From inside Open i_Notes container
docker exec -it open-i_Notes curl http://host.docker.internal:8969/v1/models
```
