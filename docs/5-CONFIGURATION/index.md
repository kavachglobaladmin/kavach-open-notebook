...
Configuration is how you customize Open i_Notes for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running Open i_Notes locally.
...
1. Set `OPEN_i_Notes_ENCRYPTION_KEY` in your environment (required for storing credentials)
2. Start services
...
```
1. Open Open i_Notes in your browser
...
2. Set OPEN_i_Notes_ENCRYPTION_KEY and database vars
3. Save
4. Restart services
```
...
| Missing encryption key | Can't save credentials | Set OPEN_i_Notes_ENCRYPTION_KEY |
...
1. **[Quick Start](../0-START-HERE/index.md)** — Run your first i_Notes
...
1. Set `OPEN_i_Notes_ENCRYPTION_KEY` in your environment
2. Start services
