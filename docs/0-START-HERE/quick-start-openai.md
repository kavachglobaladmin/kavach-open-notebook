...
Get Open i_Notes running with OpenAI's GPT models. Fast, powerful, and simple.
...
## Step 5: Create Your First i_Notes (1 min)
...
In your i_Notes, go to **Settings** → **Models** to choose:
