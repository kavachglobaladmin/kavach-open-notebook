...
Get Open i_Notes running locally in 5 minutes.
...
git clone https://github.com/YOUR_USERNAME/open-i_Notes.git
cd open-i_Notes
...
- **Frontend**: http://localhost:3000 → Open i_Notes UI
...
- **First Issue?** Pick a [good first issue](https://github.com/lfnovo/open-i_Notes/issues?q=label%3A%22good+first+issue%22)
