...
Welcome to the Open i_Notes development documentation! Whether you're contributing code, understanding our architecture, or maintaining the project, you'll find guidance here.
...
For deeper dives, check `/open_i_Notes/` CLAUDE.md for component-specific guidance.
