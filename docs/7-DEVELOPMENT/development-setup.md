...
This guide walks you through setting up Open i_Notes for local development. Follow these steps to get the full stack running on your machine.
...
git remote add upstream https://github.com/lfnovo/open-i_Notes.git
```
...
OPEN_i_Notes_ENCRYPTION_KEY=my-dev-secret-key
...
uv run pytest --cov=open_i_Notes --cov-report=html
```
