...
Before diving into how to use Open i_Notes, it's important to understand **how it thinks**. These core concepts explain the "why" behind the design.

## The Five Mental Models

### 1. [i_Notes, Sources, and Notes](i_Notes-sources-notes.md)
How Open i_Notes organizes your research. Understand the three-tier container structure and how information flows from raw materials to finished insights.

**Key idea**: A i_Notes is a scoped research container. Sources are inputs (PDFs, URLs, etc.). Notes are outputs (your insights, AI-generated summaries, captured responses).

---

### 2. [AI Context & RAG](ai-context-rag.md)
How Open i_Notes makes AI aware of your research - two different approaches.
...
Why Open i_Notes has different interaction modes and when to use each one.
...
Why Open i_Notes can turn research into audio and why this matters.
...
- **You're new to Open i_Notes** — Start here to understand how the system works conceptually before learning the features
...
Open i_Notes is built on a simple insight: **Your research deserves to stay yours**.
