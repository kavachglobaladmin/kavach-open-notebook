# AI Context & RAG - How Open i_Notes Uses Your Research

Open i_Notes uses different approaches to make AI models aware of your research depending on the feature. This section explains **RAG** (used in Ask) and **full-content context** (used in Chat).
...
When you upload a source, Open i_Notes prepares it for retrieval:
...
Open i_Notes provides two different search strategies for different goals.
...
Here's where Open i_Notes is different: **You decide what the AI sees.**
...
Open i_Notes's RAG approach gives you something you don't get with ChatGPT or Claude directly:
...
Open i_Notes gives you **two ways** to work with AI:
