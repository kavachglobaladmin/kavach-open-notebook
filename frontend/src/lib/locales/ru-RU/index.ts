export const ruRU = {
  ...
  apiErrors: {
    i_NotesNotFound: "Блокнот не найден",
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Open i_Notes недоступен",
    ...
    docLink: "Документация Open i_Notes",
  ...
  i_Notes: {
    ...
    deletei_Notes: "Удалить блокнот",
    deletei_NotesDesc: "Вы уверены, что хотите удалить «{name}»? Это действие нельзя отменить.",
    deletei_NotesLoading: "Загрузка предварительного просмотра удаления...",
    deletei_NotesNotes: "Будет удалено заметок: {count}.",
    deletei_NotesNoNotes: "Нет заметок для удаления.",
    deletei_NotesExclusiveSources: "Источников только в этом блокноте: {count}.",
    deletei_NotesharedSources: "Источников, связанных с другими блокнотами (будут отвязаны): {count}.",
    deletei_NotesNoSources: "В этом блокноте нет источников.",
    deleteExclusiveSourcesLabel: "Удалить эксклюзивные источники",
    keepExclusiveSourcesLabel: "Отвязать и сохранить",
    activei_Notes: "Активные блокноты",
    archivedi_Notes: "Архивные блокноты",
    ...
    storageLimitLabel: "Лимит хранилища",
    storageLimitHelper: "Выберите лимит хранилища, чтобы создать блокнот.",
    storageLimitHelperSelected: "Лимит установлен: {mb} MB.",
    storageLimitRequired: "Лимит хранилища обязателен",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "Невозможно сохранить заметку: ID блокнота недоступен",
    ...
    sourcesAddedToi_Notes: "Добавлено источников в блокнот: {count}",
    failedToAddSourcesToi_Notes: "Не удалось добавить источники в блокнот",
    partialAddSuccess: "Добавлено: {success}, не удалось: {failed}",
    sourceRemovedFromi_Notes: "Источник успешно удалён из блокнота",
    failedToRemoveSourceFromi_Notes: "Не удалось удалить источник из блокнота",
    ...
    managei_Notes: "Управление блокнотами",
    managei_NotesDesc: "Управление блокнотами, содержащими этот источник",
    noi_NotesAvailable: "Нет доступных блокнотов",
    loadFailed: "Не удалось загрузить детали источника",
    removeFromi_Notes: "Удалить из блокнота",
    ...
    noi_NotesFound: "Блокноты не найдены.",
  ...
  chat: {
    ...
    chatWithi_Notes: "Чат с блокнотом",
  ...
  searchPage: {
    ...
    ask: "Спросить",
    processing: "Обработка...",
    saveToi_Notes: "Сохранить в блокноты",
  ...
  podcasts: {
    ...
    loadingi_Notes: "Загрузка блокнотов...",
    noi_NotesFoundInPodcasts: "Блокноты не найдены. Создайте блокнот и добавьте контент перед генерацией подкаста.",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Open i_Notes автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Open i_Notes.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Open i_Notes",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Open i_Notes может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Open i_Notes.",
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения OPEN_i_Notes_ENCRYPTION_KEY в любую секретную строку для хранения API-ключей в базе данных.",
  ...
  setupBanner: {
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения OPEN_i_Notes_ENCRYPTION_KEY для безопасного хранения учётных данных.",
