export const frFR = {
  common: {
    ...
    accessibility: {
      ...
      searchi_Notes: "Rechercher dans les carnets",
    },
    url: "URL",
  ...
  apiErrors: {
    i_NotesNotFound: "Carnet introuvable",
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Open i_Notes est injoignable",
    ...
    docLink: "Documentation de Open i_Notes",
  ...
  i_Notes: {
    ...
    deletei_Notes: "Supprimer le carnet",
    deletei_NotesDesc: "Êtes-vous sûr de vouloir supprimer \"{name}\" ? Cette action est irréversible.",
    deletei_NotesLoading: "Chargement de l'aperçu de suppression...",
    deletei_NotesNotes: "{count} note(s) seront supprimées définitivement.",
    deletei_NotesNoNotes: "Aucune note à supprimer.",
    deletei_NotesExclusiveSources: "{count} source(s) existent uniquement dans ce carnet.",
    deletei_NotesharedSources: "{count} source(s) sont partagées avec d'autres carnets et seront déliées.",
    deletei_NotesNoSources: "Aucune source dans ce carnet.",
    deleteExclusiveSourcesLabel: "Supprimer les sources exclusives",
    keepExclusiveSourcesLabel: "Délier et les conserver",
    activei_Notes: "Carnets actifs",
    archivedi_Notes: "Carnets archivés",
    ...
    storageLimitLabel: "Limite de stockage",
    storageLimitHelper: "Sélectionnez une limite de stockage pour créer le carnet.",
    storageLimitHelperSelected: "Limite définie sur {mb} MB.",
    storageLimitRequired: "La limite de stockage est obligatoire",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "Impossible d'enregistrer la note : ID du carnet non disponible",
    ...
    sourcesAddedToi_Notes: "{count} source(s) ajoutée(s) au carnet",
    failedToAddSourcesToi_Notes: "Échec de l'ajout des sources au carnet",
    partialAddSuccess: "{success} source(s) ajoutée(s), {failed} échouée(s)",
    sourceRemovedFromi_Notes: "Source retirée du carnet avec succès",
    failedToRemoveSourceFromi_Notes: "Échec du retrait de la source du carnet",
    ...
    managei_Notes: "Gérer les carnets",
    managei_NotesDesc: "Gérer quels carnets contiennent cette source",
    noi_NotesAvailable: "Aucun carnet disponible",
    loadFailed: "Échec du chargement des détails de la source",
    removeFromi_Notes: "Retirer du carnet",
    ...
    noi_NotesFound: "Aucun carnet trouvé.",
  ...
  chat: {
    ...
    chatWithi_Notes: "Discuter avec le Carnet",
  ...
  searchPage: {
    ...
    ask: "Demander",
    processing: "Traitement...",
    saveToi_Notes: "Enregistrer dans les Carnets",
  ...
  podcasts: {
    ...
    loadingi_Notes: "Chargement des carnets...",
    noi_NotesFoundInPodcasts: "Aucun carnet trouvé. Créez un carnet et ajoutez du contenu avant de générer un podcast.",
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Open i_Notes à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Open i_Notes est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Open i_Notes",
    missingRequiredModels: "Modèles requis manquants : {models}. Open i_Notes pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Open i_Notes.",
    encryptionRequired: "Clé de chiffrement non configurée",
    encryptionRequiredDescription: "Définissez la variable d'environnement OPEN_i_Notes_ENCRYPTION_KEY avec une chaîne secrète pour activer le stockage des clés API dans la base de données.",
  ...
  setupBanner: {
    encryptionRequired: "Clé de chiffrement non configurée",
    encryptionRequiredDescription: "Définissez la variable d'environnement OPEN_i_Notes_ENCRYPTION_KEY pour activer le stockage sécurisé des identifiants.",
