export const ptBR = {
  ...
  apiErrors: {
    i_NotesNotFound: "Caderno não encontrado",
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Open i_Notes não pôde ser alcançado",
    ...
    docLink: "Documentação do Open i_Notes",
  ...
  i_Notes: {
    ...
    deletei_Notes: "Excluir Caderno",
    deletei_NotesDesc: "Tem certeza que deseja excluir \"{name}\"? Esta ação não pode ser desfeita.",
    deletei_NotesLoading: "Carregando prévia da exclusão...",
    deletei_NotesNotes: "{count} nota(s) serão permanentemente excluídas.",
    deletei_NotesNoNotes: "Nenhuma nota para excluir.",
    deletei_NotesExclusiveSources: "{count} fonte(s) existem apenas neste caderno.",
    deletei_NotesharedSources: "{count} fonte(s) são compartilhadas com outros cadernos e serão desvinculadas.",
    deletei_NotesNoSources: "Nenhuma fonte neste caderno.",
    deleteExclusiveSourcesLabel: "Excluir fontes exclusivas",
    keepExclusiveSourcesLabel: "Desvincular e manter",
    activei_Notes: "Cadernos Ativos",
    archivedi_Notes: "Cadernos Arquivados",
    ...
    storageLimitLabel: "Limite de armazenamento",
    storageLimitHelper: "Selecione um limite de armazenamento para criar o caderno.",
    storageLimitHelperSelected: "Limite definido para {mb} MB.",
    storageLimitRequired: "O limite de armazenamento é obrigatório",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "Não é possível salvar nota: ID do caderno não disponível",
    ...
    sourcesAddedToi_Notes: "{count} fonte(s) adicionada(s) ao caderno",
    failedToAddSourcesToi_Notes: "Falha ao adicionar fontes ao caderno",
    partialAddSuccess: "{success} fonte(s) adicionada(s), {failed} falhou(aram)",
    sourceRemovedFromi_Notes: "Fonte removida do caderno com sucesso",
    failedToRemoveSourceFromi_Notes: "Falha ao remover fonte do caderno",
    ...
    managei_Notes: "Gerenciar Cadernos",
    managei_NotesDesc: "Gerencie quais cadernos contêm esta fonte",
    noi_NotesAvailable: "Nenhum caderno disponível",
    loadFailed: "Falha ao carregar detalhes da fonte",
    removeFromi_Notes: "Remover do Caderno",
    ...
    noi_NotesFound: "Nenhum caderno encontrado.",
  ...
  chat: {
    ...
    chatWithi_Notes: "Conversar com Caderno",
  ...
  searchPage: {
    ...
    ask: "Perguntar",
    processing: "Processando...",
    saveToi_Notes: "Salvar em Cadernos",
  ...
  podcasts: {
    ...
    loadingi_Notes: "Carregando cadernos...",
    noi_NotesFoundInPodcasts: "Nenhum caderno encontrado. Crie um caderno e adicione conteúdo antes de gerar um podcast.",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Open i_Notes exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Open i_Notes está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Open i_Notes",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O Open i_Notes pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Open i_Notes.",
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente OPEN_i_Notes_ENCRYPTION_KEY com qualquer string secreta para armazenar chaves de API no banco de dados.",
  ...
  setupBanner: {
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente OPEN_i_Notes_ENCRYPTION_KEY para habilitar o armazenamento seguro de credenciais.",
