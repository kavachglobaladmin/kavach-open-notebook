export const bnIN = {
  common: {
    ...
    accessibility: {
      ...
      searchi_Notes: "নোটবুক অনুসন্ধান",
    },
    url: "URL",
  ...
  apiErrors: {
    i_NotesNotFound: "নোটবুক খুঁজে পাওয়া যায়নি",
  ...
  i_Notes: {
    ...
    deletei_Notes: "নোটবুক মুছে ফেলুন",
    deletei_NotesDesc: "আপনি কি নিশ্চিত \"{name}\" মুছে ফেলতে চান? এই কাজটি পুনরায় করা যাবে না।",
    deletei_NotesLoading: "মুছে ফেলার প্রিভিউ লোড হচ্ছে...",
    deletei_NotesNotes: "{count}টি নোট চিরতরে মুছে যাবে।",
    deletei_NotesNoNotes: "মুছার জন্য কোন নোট নেই।",
    deletei_NotesExclusiveSources: "{count}টি উৎস শুধুমাত্র এই নোটবুকে আছে।",
    deletei_NotesharedSources: "{count}টি উৎস অন্য নোটবুকের সাথে সাঝা করা এবং আনলিংক হবে।",
    deletei_NotesNoSources: "এই নোটবুকে কোন উৎস নেই।",
    deleteExclusiveSourcesLabel: "এক্সক্লুসিভ উৎসগুলি মুছে ফেলুন",
    keepExclusiveSourcesLabel: "আনলিংক করে রাখুন",
    activei_Notes: "সক্রিয় নোটবুক",
    archivedi_Notes: "আর্কাইভ নোটবুক",
    ...
    storageLimitHelper: "নোটবুক তৈরি করতে একটি স্টোরেজ লিমিট নির্বাচন করুন।",
    storageLimitHelperSelected: "লিমিট সেট হয়েছে {mb} MB।",
    storageLimitRequired: "স্টোরেজ লিমিট বাধ্যতামূলক",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "নোট সংরক্ষণ করতে পারা যায়নি: নোটবুক ID উপলব্ধ নয়",
    ...
    sourcesAddedToi_Notes: "{count}টি উৎস নোটবুকে যোগ করা হয়েছে",
    failedToAddSourcesToi_Notes: "নোটবুকে উৎস যোগ করতে ব্যর্থ",
    partialAddSuccess: "{success}টি উৎস যোগ হয়েছে, {failed}টি ব্যর্থ",
    sourceRemovedFromi_Notes: "নোটবুক থেকে উৎস সফলভাবে সরানো হয়েছে",
    failedToRemoveSourceFromi_Notes: "নোটবুক থেকে উৎস সরাতে ব্যর্থ",
    ...
    managei_Notes: "নোটবুক পরিচালনা করুন",
    managei_NotesDesc: "এই উৎস কোন নোটবুকে রয়েছে তা পরিচালনা করুন",
    noi_NotesAvailable: "কোন নোটবুক উপলব্ধ নয়",
    loadFailed: "উৎসের বিবরণ লোড করতে ব্যর্থ",
    removeFromi_Notes: "নোটবুক থেকে সরান",
    ...
    noi_NotesFound: "কোন নোটবুক পাওয়া যায়নি।",
  ...
  chat: {
    ...
    chatWithi_Notes: "নোটবুকের সাথে চ্যাট করুন",
  ...
  searchPage: {
    ...
    ask: "জিজ্ঞাসা",
    processing: "প্রক্রিয়াকরণ...",
    saveToi_Notes: "নোটবুকে সংরক্ষণ করুন",
    ...
    selecti_Notes: "নোটবুক নির্বাচন করুন",
  ...
  podcasts: {
    ...
    tokens: "{count} টোকেন",
    chars: "{count} অক্ষর",
    loadingi_Notes: "নোটবুক লোড হচ্ছে...",
    noi_NotesFoundInPodcasts: "কোন নোটবুক পাওয়া যায়নি। পডকাস্ট তৈরির আগে একটি নোটবুক তৈরি করে কন্টেন্ট যোগ করুন।",
  ...
  settings: {
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী Open i_Notes কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Open i_Notes এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Open i_Notes জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {models}। এগুলি ছাড়া Open i_Notes সঠিকভাবে কাজ নাও করতে পারে।",
  ...
  apiKeys: {
    ...
    description: "Open i_Notes এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
    encryptionRequired: "এনক্রিপশন কী কনফিগার করা হয়নি",
    encryptionRequiredDescription: "ডেটাবেসে API কী সংরক্ষণ করতে OPEN_i_Notes_ENCRYPTION_KEY environment variable যেকোন গোপন স্ট্রিংয়ে সেট করুন।",
  ...
  setupBanner: {
    encryptionRequired: "এনক্রিপশন কী কনফিগার করা হয়নি",
    encryptionRequiredDescription: "নিরাপদ credential স্টোরেজ সক্ষম করতে OPEN_i_Notes_ENCRYPTION_KEY environment variable সেট করুন।",
