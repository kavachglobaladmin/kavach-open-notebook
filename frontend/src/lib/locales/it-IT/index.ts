export const itIT = {
  ...
  apiErrors: {
    i_NotesNotFound: "Quaderno non trovato",
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Open i_Notes non è raggiungibile",
    ...
    docLink: "Documentazione Open i_Notes",
  ...
  i_Notes: {
    ...
    deletei_Notes: "Elimina quaderno",
    deletei_NotesDesc: "Sei sicuro di voler eliminare \"{name}\"? Questa azione non può essere annullata.",
    deletei_NotesLoading: "Caricamento anteprima eliminazione...",
    deletei_NotesNotes: "{count} nota/e verranno eliminate definitivamente.",
    deletei_NotesNoNotes: "Nessuna nota da eliminare.",
    deletei_NotesExclusiveSources: "{count} fonte/i esistono solo in questo quaderno.",
    deletei_NotesharedSources: "{count} fonte/i sono condivise con altri quaderni e verranno scollegate.",
    deletei_NotesNoSources: "Nessuna fonte in questo quaderno.",
    deleteExclusiveSourcesLabel: "Elimina fonti esclusive",
    keepExclusiveSourcesLabel: "Scollega e mantieni",
    activei_Notes: "Quaderni attivi",
    archivedi_Notes: "Quaderni archiviati",
    ...
    storageLimitLabel: "Limite di archiviazione",
    storageLimitHelper: "Seleziona un limite di archiviazione per creare il quaderno.",
    storageLimitHelperSelected: "Limite impostato a {mb} MB.",
    storageLimitRequired: "Il limite di archiviazione è obbligatorio",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "Impossibile salvare la nota: ID quaderno non disponibile",
    ...
    sourcesAddedToi_Notes: "{count} fonte/i aggiunte al quaderno",
    failedToAddSourcesToi_Notes: "Impossibile aggiungere le fonti al quaderno",
    partialAddSuccess: "{success} fonte/i aggiunte, {failed} fallite",
    sourceRemovedFromi_Notes: "Fonte rimossa dal quaderno con successo",
    failedToRemoveSourceFromi_Notes: "Impossibile rimuovere la fonte dal quaderno",
    ...
    managei_Notes: "Gestisci quaderni",
    managei_NotesDesc: "Gestisci quali quaderni contengono questa fonte",
    noi_NotesAvailable: "Nessun quaderno disponibile",
    loadFailed: "Impossibile caricare i dettagli della fonte",
    removeFromi_Notes: "Rimuovi dal quaderno",
    ...
    noi_NotesFound: "Nessun quaderno trovato.",
  ...
  chat: {
    ...
    chatWithi_Notes: "Chatta con il quaderno",
  ...
  searchPage: {
    ...
    ask: "Chiedi",
    processing: "Elaborazione...",
    saveToi_Notes: "Salva nei quaderni",
  ...
  podcasts: {
    ...
    loadingi_Notes: "Caricamento quaderni...",
    noi_NotesFoundInPodcasts: "Nessun quaderno trovato. Crea un quaderno e aggiungi contenuto prima di generare un podcast.",
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Open i_Notes di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Open i_Notes.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Open i_Notes",
    missingRequiredModels: "Modelli richiesti mancanti: {models}. Open i_Notes potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Open i_Notes.",
    encryptionRequired: "Chiave di crittografia non configurata",
    encryptionRequiredDescription: "Imposta la variabile d'ambiente OPEN_i_Notes_ENCRYPTION_KEY su una stringa segreta qualsiasi per abilitare il salvataggio delle chiavi API nel database.",
  ...
  setupBanner: {
    encryptionRequired: "Chiave di crittografia non configurata",
    encryptionRequiredDescription: "Imposta la variabile d'ambiente OPEN_i_Notes_ENCRYPTION_KEY per abilitare l'archiviazione sicura delle credenziali.",
