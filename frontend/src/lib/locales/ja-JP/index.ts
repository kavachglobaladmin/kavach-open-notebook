export const jaJP = {
  ...
  apiErrors: {
    i_NotesNotFound: "ノートブックが見つかりません",
  ...
  connectionErrors: {
    ...
    apiDesc: "Open i_Notes APIサーバーに到達できませんでした",
  ...
  i_Notes: {
    ...
    archive: "アーカイブ",
    unarchive: "アーカイブ解除",
    deletei_Notes: "ノートブックを削除",
    deletei_NotesDesc: "\"{name}\" を削除しますか？この操作は元に戻せません。",
    deletei_NotesLoading: "削除プレビューを読み込み中...",
    deletei_NotesNotes: "{count}件のノートが完全に削除されます。",
    deletei_NotesNoNotes: "削除するノートはありません。",
    deletei_NotesExclusiveSources: "{count}件のソースはこのノートブックにのみ存在します。",
    deletei_NotesharedSources: "{count}件のソースは他のノートブックと共有されており、リンクが解除されます。",
    deletei_NotesNoSources: "このノートブックにソースはありません。",
    deleteExclusiveSourcesLabel: "専用ソースを削除",
    keepExclusiveSourcesLabel: "リンク解除して保持",
    activei_Notes: "アクティブなノートブック",
    archivedi_Notes: "アーカイブ済みノートブック",
    ...
    storageLimitLabel: "ストレージ上限",
    storageLimitHelper: "ノートブックを作成するにはストレージ上限を選択してください。",
    storageLimitHelperSelected: "上限を {mb} MB に設定しました。",
    storageLimitRequired: "ストレージ上限は必須です",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "ノートを保存できません：ノートブックIDが利用できません",
    ...
    sourcesAddedToi_Notes: "{count}件のソースをノートブックに追加しました",
    failedToAddSourcesToi_Notes: "ノートブックへのソース追加に失敗しました",
    partialAddSuccess: "{success}件追加成功、{failed}件失敗",
    sourceRemovedFromi_Notes: "ノートブックからソースを削除しました",
    failedToRemoveSourceFromi_Notes: "ノートブックからのソース削除に失敗しました",
    ...
    managei_Notes: "ノートブックを管理",
    managei_NotesDesc: "このソースを含むノートブックを管理",
    noi_NotesAvailable: "利用可能なノートブックがありません",
    loadFailed: "ソース詳細の読み込みに失敗しました",
    removeFromi_Notes: "ノートブックから削除",
  ...
  podcasts: {
    ...
    tokens: "{count}トークン",
    chars: "{count}文字",
    loadingi_Notes: "ノートブックを読み込み中...",
    noi_NotesFoundInPodcasts: "ノートブックが見つかりません。ポッドキャストを生成する前にノートブックを作成してコンテンツを追加してください。",
  ...
  settings: {
    ...
    filesHelp: "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはOpen i_Notesがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Open i_Notesの新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Open i_Notes全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {models}。これらがないとOpen i_Notesが正しく機能しない可能性があります。",
  ...
  apiKeys: {
    ...
    description: "APIキーをデータベースに安全に保存し、Open i_NotesでAIプロバイダーを有効にします。",
    encryptionRequired: "暗号化キーが設定されていません",
    encryptionRequiredDescription: "OPEN_i_Notes_ENCRYPTION_KEY 環境変数に任意の秘密文字列を設定して、データベースへのAPIキーの保存を有効にしてください。",
    configured: "設定済み",
    notConfigured: "未設定",
  ...
  setupBanner: {
    encryptionRequired: "暗号化キーが設定されていません",
    encryptionRequiredDescription: "OPEN_i_Notes_ENCRYPTION_KEY 環境変数を設定して、安全な認証情報の保存を有効にしてください。",
