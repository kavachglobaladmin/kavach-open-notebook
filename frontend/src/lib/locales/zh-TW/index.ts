export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 Open i_Notes API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  i_Notes: {
    ...
    unarchive: "取消封存",
    deletei_Notes: "刪除筆記本",
    deletei_NotesDesc: "您確定要刪除 \"{name}\" 嗎？此操作無法復原。",
    deletei_NotesLoading: "正在載入刪除預覽...",
    deletei_NotesNotes: "{count} 個筆記將被永久刪除。",
    deletei_NotesNoNotes: "沒有要刪除的筆記。",
    deletei_NotesExclusiveSources: "{count} 個來源僅存在於此筆記本中。",
    deletei_NotesharedSources: "{count} 個來源與其他筆記本共享，將被取消關聯。",
    deletei_NotesNoSources: "此筆記本中沒有來源。",
    deleteExclusiveSourcesLabel: "刪除專屬來源",
    keepExclusiveSourcesLabel: "取消關聯並保留",
    activei_Notes: "活動中的筆記本",
    archivedi_Notes: "封存的筆記本",
    notFound: "未找到筆記本",
    ...
    storageLimitHelper: "請先選擇儲存上限再建立筆記本。",
    storageLimitHelperSelected: "已設定為 {mb} MB。",
    storageLimitRequired: "必須選擇儲存上限",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "無法儲存筆記：缺少筆記本 ID",
    ...
    failedToRetry: "重試失敗",
    sourcesAddedToi_Notes: "{count} 個來源已新增到筆記本",
    failedToAddSourcesToi_Notes: "新增來源到筆記本失敗",
    partialAddSuccess: "{success} 個來源已新增，{failed} 個失敗",
    sourceRemovedFromi_Notes: "來源已成功從筆記本中移除",
    failedToRemoveSourceFromi_Notes: "從筆記本中移除來源失敗",
    ...
    sourceInsight: "來源見解",
    managei_Notes: "管理所屬筆記本",
    managei_NotesDesc: "管理包含此來源的筆記本",
    noi_NotesAvailable: "暫無可用筆記本",
    loadFailed: "載入來源詳情失敗",
    removeFromi_Notes: "從筆記本移除",
  ...
  podcasts: {
    ...
    tokens: "{count} token",
    chars: "{count} 字元",
    loadingi_Notes: "正在載入筆記本...",
    noi_NotesFoundInPodcasts: "未找到筆記本。在生成播客之前，請先建立一個筆記本並新增內容。",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 Open i_Notes 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，Open i_Notes 可能無法正常運行。",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 Open i_Notes 中啟用 AI 服務商。",
    encryptionRequired: "未設定加密金鑰",
    encryptionRequiredDescription: "請將 OPEN_i_Notes_ENCRYPTION_KEY 環境變數設定為任意密鑰字串，以啟用將 API 金鑰儲存至資料庫。",
    configured: "已設定",
    notConfigured: "未設定",
  ...
  setupBanner: {
    encryptionRequired: "未設定加密金鑰",
    encryptionRequiredDescription: "請設定 OPEN_i_Notes_ENCRYPTION_KEY 環境變數以啟用安全憑據儲存。",
