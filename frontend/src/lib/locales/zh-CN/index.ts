export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 Open i_Notes API 服务器",
    dbTitle: "数据库连接失败",
  ...
  i_Notes: {
    ...
    unarchive: "取消归档",
    deletei_Notes: "删除笔记本",
    deletei_NotesDesc: "您确定要删除 \"{name}\" 吗？此操作无法撤销。",
    deletei_NotesLoading: "正在加载删除预览...",
    deletei_NotesNotes: "{count} 个笔记将被永久删除。",
    deletei_NotesNoNotes: "没有要删除的笔记。",
    deletei_NotesExclusiveSources: "{count} 个来源仅存在于此笔记本中。",
    deletei_NotesharedSources: "{count} 个来源与其他笔记本共享，将被取消关联。",
    deletei_NotesNoSources: "此笔记本中没有来源。",
    deleteExclusiveSourcesLabel: "删除专属来源",
    keepExclusiveSourcesLabel: "取消关联并保留",
    activei_Notes: "活动的笔记本",
    archivedi_Notes: "归档的笔记本",
    notFound: "未找到笔记本",
    ...
    storageLimitHelper: "请选择存储上限后再创建笔记本。",
    storageLimitHelperSelected: "已设置为 {mb} MB。",
    storageLimitRequired: "必须选择存储上限",
  ...
  sources: {
    ...
    cannotSaveNoteNoi_Notes: "无法保存笔记：缺少笔记本 ID",
    ...
    failedToRetry: "重试失败",
    sourcesAddedToi_Notes: "{count} 个来源已添加到笔记本",
    failedToAddSourcesToi_Notes: "添加来源到笔记本失败",
    partialAddSuccess: "{success} 个来源已添加，{failed} 个失败",
    sourceRemovedFromi_Notes: "来源已成功从笔记本中移除",
    failedToRemoveSourceFromi_Notes: "从笔记本中移除来源失败",
    ...
    sourceInsight: "来源见解",
    managei_Notes: "管理所属笔记本",
    managei_NotesDesc: "管理包含此来源的笔记本",
    noi_NotesAvailable: "暂无可用笔记本",
    loadFailed: "加载来源详情失败",
    removeFromi_Notes: "从笔记本移除",
  ...
  podcasts: {
    ...
    tokens: "{count} token",
    chars: "{count} 字符",
    loadingi_Notes: "正在加载笔记本...",
    noi_NotesFoundInPodcasts: "未找到笔记本。在生成播客之前，请先创建一个笔记本并添加内容。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Open i_Notes 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 Open i_Notes 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，Open i_Notes 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 Open i_Notes 中启用 AI 服务商。",
    encryptionRequired: "未配置加密密钥",
    encryptionRequiredDescription: "请将 OPEN_i_Notes_ENCRYPTION_KEY 环境变量设置为任意密钥字符串，以启用将 API 密钥存储到数据库。",
    configured: "已配置",
    notConfigured: "未配置",
  ...
  setupBanner: {
    encryptionRequired: "未配置加密密钥",
    encryptionRequiredDescription: "请设置 OPEN_i_Notes_ENCRYPTION_KEY 环境变量以启用安全凭据存储。",
