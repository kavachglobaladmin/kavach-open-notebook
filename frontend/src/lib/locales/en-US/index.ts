export const enUS = {
  ...
  apiErrors: {
    i_NotesNotFound: "Case not found",
  ...
  connectionErrors: {
    ...
    apiDesc: "The Open i_Notes API server could not be reached",
    ...
    // docLink: "Open i_Notes Documentation",
  ...
  i_Notes: {
    ...
    archive: "Archive",
    unarchive: "Unarchive",
    deletei_Notes: "Delete i_Notes",
    deletei_NotesDesc: "Are you sure you want to delete \"{name}\"? This action cannot be undone.",
    deletei_NotesLoading: "Loading deletion preview...",
    deletei_NotesNotes: "{count} note(s) will be permanently deleted.",
    deletei_NotesNoNotes: "No notes to delete.",
    deletei_NotesExclusiveSources: "{count} source(s) exist only in this i_Notes.",
    deletei_NotesharedSources: "{count} source(s) are shared with other i_Notes and will be unlinked.",
    deletei_NotesNoSources: "No sources in this i_Notes.",
    deleteExclusiveSourcesLabel: "Delete exclusive sources",
    keepExclusiveSourcesLabel: "Unlink and keep them",
    activei_Notes: "Active Cases",
    archivedi_Notes: "Archived Cases",
    notFound: "Case not found",
    notFoundDesc: "The requested case does not exist.",
    updated: "Updated",
    namePlaceholder: "i_Notes name",
    ...
    createNew: "Create New i_Notes",
    createNewDesc: "Enter a name and optional description to get started.",
    descPlaceholder: "Add more info about this i_Notes here...",
    storageLimitLabel: "Storage Limit",
    storageLimitHelper: "Select a storage limit to create the i_Notes.",
    storageLimitHelperSelected: "Limit set to {mb} MB.",
    storageLimitRequired: "Storage limit is required",
    createSuccess: "i_Notes created successfully",
    updateSuccess: "i_Notes updated successfully",
    deleteSuccess: "i_Notes deleted successfully",
  },
  sources: {
    title: "Sources",
    add: "Add Source",
    ...
    cannotSaveNoteNoi_Notes: "Cannot save note: i_Notes ID not available",
    ...
    sourcesAddedToi_Notes: "{count} source(s) added to i_Notes",
    failedToAddSourcesToi_Notes: "Failed to add sources to i_Notes",
    partialAddSuccess: "{success} source(s) added, {failed} failed",
    sourceRemovedFromi_Notes: "Source removed from i_Notes successfully",
    failedToRemoveSourceFromi_Notes: "Failed to remove source from i_Notes",
    removeConfirm: "Are you sure you want to remove this from the i_Notes?",
    checking: "Checking...",
    ...
    batchCommonSettings: "The same i_Notes and transformations will be applied to all items.",
    ...
    managei_Notes: "Manage i_Notes",
    managei_NotesDesc: "Manage which i_Notes contain this source",
    noi_NotesAvailable: "No i_Notes available",
    loadFailed: "Failed to load source details",
    removeFromi_Notes: "Remove from i_Notes",
    retryProcessing: "Retry Processing",
    deleteSource: "Delete Source",
    retry: "Retry",
    addExistingTitle: "Add Existing Sources",
    addExistingDesc: "Select existing sources from across all your i_Notes to add to the current one.",
    searchPlaceholder: "Search sources by name or URL...",
    noi_NotesFound: "No i_Notes found.",
    ...
    mobileData: {
      analysisTitle: "Mobile data",
      reportHeading: "CDR & usage intelligence",
      analysisTooltip: "Mobile / CDR analysis",
      loading: "Reading CDR or SMS export…",
      recordsLabel: "parsed rows",
      footerRecords: "rows analysed",
      rowsParsedLabel: "Parsed rows",
      uniqueContacts: "Unique contacts",
      totalCalls: "Calls (est.)",
      smsRows: "SMS rows",
      totalMinutes: "Total minutes",
      avgDurationSec: "Avg duration (sec)",
      dateRange: "Date span",
      nightActivity: "Night activity",
      operatorsInFile: "Operators mentioned in export",
      noData: "No data.",
      sectionSummary: "Summary",
      sectionCallActivity: "Call activity",
      sectionTopContacts: "Top contacts",
      sectionTimePattern: "Time pattern",
      sectionOperatorSms: "Operator / SMS",
      sectionLocation: "Location",
      sectionDeviceSim: "Device & SIM",
      sectionSuspicious: "Suspicious",
      ...
      outbound: "Out",
      durationSec: "Dur (sec)",
      peakHour: "Peak hour (local timestamps)",
      nightWindow: "Share 22:00–06:00",
      smsLikeRows: "SMS-classified rows",
      lac: "LAC hints",
      cellId: "Cell ID hints",
      imeiCandidates: "candidates",
      noFlags: "No heuristic alerts for this snapshot.",
    },
  },
  chat: {
    sessions: "Sessions",
    ...
    chatWithi_Notes: "Chat with i_Notes",
    unableToLoadChat: "Unable to load chat",
    noDescription: "No description",
    startByCreating: "Start by creating your first i_Notes to organize your research.",
  ...
  searchPage: {
    ...
    notSet: "Not set",
    saveToi_Notes: "Save to i_Notes",
    saveSuccess: "Successfully saved to i_Notes",
    saveError: "Failed to save to i_Notes",
    selecti_Notes: "Select i_Notes",
  ...
  podcasts: {
    ...
    content: "Content",
    contentDesc: "Pick i_Notes, sources, and notes to include in this episode.",
    itemsSelected: "{count} items selected",
    tokens: "{count} tokens",
    chars: "{count} chars",
    loadingi_Notes: "Loading i_Notes...",
    noi_NotesFoundInPodcasts: "No i_Notes found. Create a i_Notes and add content before generating a podcast.",
    ...
    sources: "Sources",
    notes: "Notes",
    noSources: "No sources available in this i_Notes.",
    noNotes: "No notes available in this i_Notes.",
    ...
    noEpisodesYet: "No podcast episodes yet. Generate your first one from the i_Notes or source chat interfaces.",
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Open i_Notes to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Open i_Notes is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Open i_Notes",
    missingRequiredModels: "Missing required models: {models}. Open i_Notes may not function properly without these.",
  ...
  apiKeys: {
    ...
    description: "Store API keys securely in the database to enable AI providers in Open i_Notes.",
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the OPEN_i_Notes_ENCRYPTION_KEY environment variable to any secret string to enable storing API keys in the database.",
  ...
  setupBanner: {
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the OPEN_i_Notes_ENCRYPTION_KEY environment variable to enable secure credential storage.",
