...
const PROTECTED_ROUTES: ProtectedRoute[] = [
  ...
  { path: '/organizations', minimumRole: 'super_admin' },
  { path: '/admins', minimumRole: 'super_admin' },
  { path: '/users', minimumRole: 'super_admin' },
  { path: '/audit-logs', minimumRole: 'super_admin' },
