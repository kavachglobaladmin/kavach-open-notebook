"""
Unit tests for the open_i_Notes.utils.embedding module.
...
from i_Notes.utils.embedding import (
    generate_embedding,
    generate_embeddings,
...
class TestGenerateEmbeddings:
    ...
    async def test_no_model_raises(self):
        ...
        with patch(
            "open_i_Notes.ai.models.model_manager.get_embedding_model",
...
class TestGenerateEmbedding:
    ...
    async def test_content_type_parameter(self):
        ...
        from i_Notes.utils.chunking import ContentType
    ...
    async def test_batching(self):
        ...
        from i_Notes.utils.embedding import EMBEDDING_BATCH_SIZE
    ...
    async def test_batch_retry_on_transient_failure(self):
        ...
        with (
            ...
            patch("open_i_Notes.utils.embedding.EMBEDDING_RETRY_DELAY", 0),
        ):
            result = await generate_embeddings(texts)
    ...
    async def test_batch_retry_exhaustion(self):
        ...
        from i_Notes.utils.embedding import EMBEDDING_MAX_RETRIES
...
class TestErrorClassifier413:
    ...
    def test_413_status_code(self):
        from i_Notes.exceptions import ExternalServiceError
