"""
Unit tests for the open_i_Notes.utils module.
...
from i_Notes.utils.context_builder import ContextBuilder, ContextConfig
...
class TestVersionUtilities:
    ...
    def test_get_version_from_github_invalid_url(self):
        ...
        from i_Notes.utils.version_utils import get_version_from_github
...
class TestContextBuilder:
    ...
    def test_context_builder_initialization(self):
        ...
        builder = ContextBuilder(
            ...
            i_Notes_id="i_Notes:456",
            max_tokens=1000,
            include_insights=False,
        )

        assert builder.source_id == "source:123"
        assert builder.i_Notes_id == "i_Notes:456"
