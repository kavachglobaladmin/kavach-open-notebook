...
class ChatService:
    ...
    def __init__(self):
        ...
        self.headers = {}
        password = os.getenv("i_Notes_PASSWORD")
        if password:
            self.headers["Authorization"] = f"Bearer {password}"

    async def get_sessions(self, i_Notes_id: str) -> List[Dict[str, Any]]:
        """Get all chat sessions for a i_Notes_id"""
        try:
    ...
    async def build_context(
        self, i_Notes_id: str, context_config: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Build context for a i_Notes_id"""
        try:
            data = {"i_Notes_id": i_Notes_id, "context_config": context_config}
