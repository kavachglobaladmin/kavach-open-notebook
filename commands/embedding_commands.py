...
from i_Notes.database.repository import ensure_record_id, repo_insert, repo_query
from i_Notes.exceptions import ConfigurationError
from i_Notes.domain.i_Notes import Note, Source, SourceInsight
from i_Notes.utils.chunking import ContentType, chunk_text, detect_content_type
from i_Notes.utils.embedding import generate_embedding, generate_embeddings
...
@command("rebuild_embeddings", app="open_i_Notes", retry=None)
